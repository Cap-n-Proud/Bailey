...
then
    ...
    git clone https://github.com/pfnegrini/Bailey.git /home/pi/Documents/Sketches
    sudo cp /home/pi/Documents/Sketches/server/install/robotserver /etc/init.d/robotserver
